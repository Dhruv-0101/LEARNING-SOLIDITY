...
contract Vote {
    ...
    uint nextVoterId = 1;//starting
    uint nextCandidateId = 1;//starting
    ...
    modifier isVotingOver() {
        require(block.timestamp<=endTime && stopVoting==false,"Voting time is over");//user is modifier ko call kab karega uspe dependent hai
      _;
    }
